...
def setup_logging(log_filepath=None):
    ...
    logging.addLevelName(level=logging.DEBUG, levelName="D")
    logging.addLevelName(level=logging.INFO, levelName="I")
    logging.addLevelName(level=logging.WARNING, levelName="W")
    logging.addLevelName(level=logging.ERROR, levelName="E")
    logging.addLevelName(level=logging.CRITICAL, levelName="C")
