...
def main(cfg):
    heyhi.setup_logging(cfg.logfile)
    ...
    task = getattr(cfv.tasks, cfg.task)
    return task(cfg)
...
if __name__ == "__main__":
    ...
    # torch does not support `fork` start method well
    # subprocesses should be started with `spawn` or `forkserver`
